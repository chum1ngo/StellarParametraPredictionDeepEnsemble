...
def __main__():
	...
	i = int(i_fp.readline())
	i_fp.close()
	weights_fp = open('./raw_data_predictions/weights.txt','a')
	...
	test_predictions_fp = open('./raw_data_predictions/test/'+str(i)+'.predictions.txt','w')
	obs_predictions_fp = open('./raw_data_predictions/obs/'+str(i)+'.predictions.txt','w')
